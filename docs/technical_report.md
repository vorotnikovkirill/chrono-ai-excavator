...
Publication-closeout totals:

- overlap-safe calendar duration: 1 hour 13 minutes 23 seconds;
- human active effort: 32.1 minutes;
...
- iterations: 8 initial, 6 corrections, 4 repeated runs, and 0 rework events;
- AI-result counts: 11 accepted, 5 accepted with corrections, 1 rejected, and 2 pending review;
- estimate quality: 4 measured, 17 timestamp-derived, and 2 approximate records.
