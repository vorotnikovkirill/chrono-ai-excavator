...
- overlap-safe calendar duration: 1 hour 18 minutes 57 seconds;
- human active effort: 37.7 minutes;
...
- iterations: 17 initial, 9 corrections, 4 repeated runs, and 0 rework events;
- AI-result counts: 16 accepted, 5 accepted with corrections, 1 rejected, and 0 pending review;
- estimate quality: 14 measured, 20 timestamp-derived, and 2 approximate records.
