...
- overlap-safe calendar duration: 1 hour 24 minutes 54 seconds;
- human active effort: 40.8 minutes;
- Codex/AI wall time: 13 minutes 1 second;
- simulation/computation wall time: 30 seconds;
- documented attributable software and infrastructure cost: none measurable;
- iterations: 23 initial, 12 corrections, 4 repeated runs, and 0 rework events;
- AI-result counts: 19 accepted, 6 accepted with corrections, 1 rejected, and 0 pending review;
- estimate quality: 21 measured, 22 timestamp-derived, and 2 approximate records.
